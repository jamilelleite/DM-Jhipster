...
public class LivreursResource {
     ...
     */
    @GetMapping("/livreurs")
    public ResponseEntity<List<LivreursDTO>> getAllLivreurs(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Livreurs");
        Page<LivreursDTO> page = livreursService.findAll(pageable);
