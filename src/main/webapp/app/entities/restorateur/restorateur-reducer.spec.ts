...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESTORATEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESTORATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESTORATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESTORATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESTORATEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESTORATEUR actions', async () => {
      const expectedActions = [
        {
