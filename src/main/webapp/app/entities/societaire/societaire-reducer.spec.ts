...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIETAIRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIETAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIETAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIETAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIETAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIETAIRE actions', async () => {
      const expectedActions = [
        {
