...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './conseil.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSEIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONSEIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONSEIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONSEIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONSEIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONSEIL actions', async () => {
      const expectedActions = [
        {
