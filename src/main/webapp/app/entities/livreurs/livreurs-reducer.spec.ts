...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './livreurs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIVREURS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIVREURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIVREURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIVREURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIVREURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIVREURS actions', async () => {
      const expectedActions = [
        {
