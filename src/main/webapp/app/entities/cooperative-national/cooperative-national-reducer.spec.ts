...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cooperative-national.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COOPERATIVENATIONAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_COOPERATIVENATIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COOPERATIVENATIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COOPERATIVENATIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COOPERATIVENATIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COOPERATIVENATIONAL actions', async () => {
      const expectedActions = [
        {
