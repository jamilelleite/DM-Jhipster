...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().name(DEFAULT_NAME).address(DEFAULT_ADDRESS);
        // Add required entity
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().name(UPDATED_NAME).address(UPDATED_ADDRESS);
        // Add required entity
        Societaire societaire;
        if (TestUtil.findAll(em, Societaire.class).isEmpty()) {
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME).address(UPDATED_ADDRESS);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME).address(UPDATED_ADDRESS);
